                    		...
                    		<tbody>
                    			<tr v-for="(category, index) in categories" :key="index">
                    				...
                    				<td>
                    					...
                    					<button class="btn btn-primary btn-sm" v-on:click="deleteCategory(category)"><span class="fa fa-trash"></span></button>
                    				</td>
                    			</tr>
                    		</tbody>
                    	</table>
            ...
            <div class="d-block">
                <form v-on:submit.prevent="createCategory">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Enter category name" v-model="categoryData.name">
                        <div class="invalid-feedback" v-if="errors.name">{{ errors.name[0] }}</div>
                    </div>
                    <div class="form-group">
                        <label for="image">Choose an image</label>
                        <div v-if="categoryData.image.name">
                            <img class="w-150px" src="" ref="newCategoryImageDisplay">
                        </div>
                        <input ref="newCategoryImage" type="file" class="form-control" id="image" v-on:change="attachImage">
        ...
        <b-modal ref="editCategoryModal" hide-footer title="Update Category">
            <div class="d-block">
                <form v-on:submit.prevent="updateCategory">
                    <div class="form-group">
                        <label for="name">Enter Name</label>
                        <input type="text" class="form-control" id="name" placeholder="Enter category name" v-model="editCategoryData.name">
                        <div class="invalid-feedback" v-if="errors.name">{{ errors.name[0] }}</div>
                    </div>
                    <div class="form-group">
                        <label for="image">Choose an image</label>
                        <div>
                            <img class="w-150px" :src="`${$store.state.serverPath}/storage/${editCategoryData.image}`" ref="editCategoryImageDisplay">
                        </div>
                        <input ref="editCategoryImage" type="file" class="form-control" id="image" v-on:change="editAttachImage">
                        <div class="invalid-feedback" v-if="errors.image">{{ errors.image[0] }}</div>
                    </div>
                    <hr>
                    <div class="text-right">
